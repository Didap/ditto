...
# These must match the real production values
ARG NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY
ARG NEXT_PUBLIC_STRIPE_PRO_PRICE_ID
ARG NEXT_PUBLIC_STRIPE_TEAM_PRICE_ID
ARG NEXT_PUBLIC_STRIPE_PACK_500_PRICE_ID
ARG NEXT_PUBLIC_STRIPE_PACK_2000_PRICE_ID
ARG NEXT_PUBLIC_STRIPE_PACK_5000_PRICE_ID
...
ENV NEXT_PUBLIC_STRIPE_PACK_500_PRICE_ID=$NEXT_PUBLIC_STRIPE_PACK_500_PRICE_ID
ENV NEXT_PUBLIC_STRIPE_PACK_2000_PRICE_ID=$NEXT_PUBLIC_STRIPE_PACK_2000_PRICE_ID
ENV NEXT_PUBLIC_STRIPE_PACK_5000_PRICE_ID=$NEXT_PUBLIC_STRIPE_PACK_5000_PRICE_ID
